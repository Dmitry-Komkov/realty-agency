...
module.exports = {
  siteMetadata: {
    title: `АН "ФАВОРИТ"`,
    description: `Покупка и продажа квартир, домов, участков, аренда жилой и коммерческой недвижимости. Помощь в получении ипотеки. Выплата до 90% рыночной стоимости. Команда экспертов. Юридическое сопровождение. Работаем в Чехове, Чеховском районе и Южном Подмосковье.`,
